...
public class hdf5_getters {
	...
	public static H5File hdf5_open_readonly(String filename) {
		return new H5File(filename, FileFormat.READ);
	}
	...
	public static double get_artist_familiarity(H5File h5) throws Exception {
		return hdf5_getters.get_artist_familiarity(h5, 0);
	}

	public static double get_artist_familiarity(H5File h5, int songidx)
			throws Exception {
		return hdf5_getters.get_member_double(h5, songidx, "/metadata/songs",
				"artist_familiarity");
	}

	public static double get_artist_hotttnesss(H5File h5) throws Exception {
		return hdf5_getters.get_artist_hotttnesss(h5, 0);
	}
	...
	public static String get_artist_id(H5File h5) throws Exception {
		return hdf5_getters.get_artist_id(h5, 0);
	}

	public static String get_artist_id(H5File h5, int songidx) throws Exception {
		return hdf5_getters.get_member_string(h5, songidx, "/metadata/songs",
				"artist_id");
	}

	public static String get_artist_mbid(H5File h5) throws Exception {
		return hdf5_getters.get_artist_mbid(h5, 0);
	}
	...
	public static int get_artist_playmeid(H5File h5) throws Exception {
		return hdf5_getters.get_artist_playmeid(h5, 0);
	}

	public static int get_artist_playmeid(H5File h5, int songidx)
			throws Exception {
		return hdf5_getters.get_member_int(h5, songidx, "/metadata/songs",
				"artist_playmeid");
	}

	public static int get_artist_7digitalid(H5File h5) throws Exception {
		return hdf5_getters.get_artist_7digitalid(h5, 0);
	}
	...
	public static double get_artist_latitude(H5File h5) throws Exception {
		return hdf5_getters.get_artist_latitude(h5, 0);
	}
	...
	public static double get_artist_longitude(H5File h5) throws Exception {
		return hdf5_getters.get_artist_longitude(h5, 0);
	}
	...
	public static String get_artist_location(H5File h5) throws Exception {
		return hdf5_getters.get_artist_location(h5, 0);
	}
	...
	public static String get_artist_name(H5File h5) throws Exception {
		return hdf5_getters.get_artist_name(h5, 0);
	}
	...
	public static String get_release(H5File h5) throws Exception {
		return hdf5_getters.get_release(h5, 0);
	}
	...
	public static int get_release_7digitalid(H5File h5) throws Exception {
		return hdf5_getters.get_release_7digitalid(h5, 0);
	}
	...
	public static String get_song_id(H5File h5) throws Exception {
		return hdf5_getters.get_song_id(h5, 0);
	}
	...
	public static double get_song_hotttnesss(H5File h5) throws Exception {
		return hdf5_getters.get_song_hotttnesss(h5, 0);
	}
	...
	public static String get_title(H5File h5) throws Exception {
		return hdf5_getters.get_title(h5, 0);
	}
	...
	public static int get_track_7digitalid(H5File h5) throws Exception {
		return hdf5_getters.get_track_7digitalid(h5, 0);
	}
	...
	public static String[] get_similar_artists(H5File h5) throws Exception {
		return hdf5_getters.get_similar_artists(h5, 0);
	}

	public static String[] get_similar_artists(H5File h5, int songidx)
			throws Exception {
		return hdf5_getters.get_array_string(h5, songidx, "metadata",
				"similar_artists");
	}

	public static String[] get_artist_terms(H5File h5) throws Exception {
		return hdf5_getters.get_artist_terms(h5, 0);
	}
	...
	public static double get_duration(H5File h5) throws Exception {
		return hdf5_getters.get_duration(h5, 0);
	}
	...
	public static double get_end_of_fade_in(H5File h5) throws Exception {
		return hdf5_getters.get_end_of_fade_in(h5, 0);
	}
	...
	public static double get_energy(H5File h5) throws Exception {
		return hdf5_getters.get_energy(h5, 0);
	}
	...
	public static int get_key(H5File h5) throws Exception {
		return hdf5_getters.get_key(h5, 0);
	}

	public static int get_key(H5File h5, int songidx) throws Exception {
		return hdf5_getters.get_member_int(h5, songidx, "/analysis/songs",
				"key");
	}

	public static double get_key_confidence(H5File h5) throws Exception {
		return hdf5_getters.get_key_confidence(h5, 0);
	}
	...
	public static double get_loudness(H5File h5) throws Exception {
		return hdf5_getters.get_loudness(h5, 0);
	}
	...
	public static int get_mode(H5File h5) throws Exception {
		return hdf5_getters.get_mode(h5, 0);
	}
	...
	public static double get_mode_confidence(H5File h5) throws Exception {
		return hdf5_getters.get_mode_confidence(h5, 0);
	}
	...
	public static double get_start_of_fade_out(H5File h5) throws Exception {
		return hdf5_getters.get_start_of_fade_out(h5, 0);
	}
	...
	public static double get_tempo(H5File h5) throws Exception {
		return hdf5_getters.get_tempo(h5, 0);
	}
	...
	public static int get_time_signature(H5File h5) throws Exception {
		return hdf5_getters.get_time_signature(h5, 0);
	}
	...
	public static double get_time_signature_confidence(H5File h5)
			throws Exception {
		return hdf5_getters.get_time_signature_confidence(h5, 0);
	}
	...
	public static String get_track_id(H5File h5) throws Exception {
		return hdf5_getters.get_track_id(h5, 0);
	}
	...
	public static double[] get_segments_start(H5File h5) throws Exception {
		return hdf5_getters.get_segments_start(h5, 0);
	}

	public static double[] get_segments_start(H5File h5, int songidx)
			throws Exception {
		return hdf5_getters.get_array_double(h5, songidx, "analysis",
				"segments_start", 1);
	}

	public static double[] get_segments_confidence(H5File h5) throws Exception {
		return hdf5_getters.get_segments_confidence(h5, 0);
	}
	...
	public static double[] get_segments_pitches(H5File h5) throws Exception {
		return hdf5_getters.get_segments_pitches(h5, 0);
	}
	...
	public static double[] get_segments_timbre(H5File h5) throws Exception {
		return hdf5_getters.get_segments_timbre(h5, 0);
	}
	...
	public static double[] get_segments_loudness_max(H5File h5)
			throws Exception {
		return hdf5_getters.get_segments_loudness_max(h5, 0);
	}
	...
	public static double[] get_segments_loudness_max_time(H5File h5)
			throws Exception {
		return hdf5_getters.get_segments_loudness_max_time(h5, 0);
	}
	...
	public static double[] get_segments_loudness_start(H5File h5)
			throws Exception {
		return hdf5_getters.get_segments_loudness_start(h5, 0);
	}
	...
	public static double[] get_sections_start(H5File h5) throws Exception {
		return hdf5_getters.get_sections_start(h5, 0);
	}
	...
	public static double[] get_sections_confidence(H5File h5) throws Exception {
		return hdf5_getters.get_sections_confidence(h5, 0);
	}
	...
	public static double[] get_beats_start(H5File h5) throws Exception {
		return hdf5_getters.get_beats_start(h5, 0);
	}
	...
	public static double[] get_beats_confidence(H5File h5) throws Exception {
		return hdf5_getters.get_beats_confidence(h5, 0);
	}
	...
	public static double[] get_bars_start(H5File h5) throws Exception {
		return hdf5_getters.get_bars_start(h5, 0);
	}
	...
	public static double[] get_bars_confidence(H5File h5) throws Exception {
		return hdf5_getters.get_bars_confidence(h5, 0);
	}
	...
	public static double[] get_tatums_start(H5File h5) throws Exception {
		return hdf5_getters.get_tatums_start(h5, 0);
	}
	...
	public static double[] get_tatums_confidence(H5File h5) throws Exception {
		return hdf5_getters.get_tatums_confidence(h5, 0);
	}
	...
	public static int get_member_int(H5File h5, int songidx, String table,
		...
		analysis.init();
		int wantedMember = hdf5_getters.find(analysis.getMemberNames(), member);
	...
	public static double[] get_array_double(H5File h5, int songidx,
		...
		return hdf5_getters.get_array_double(h5, songidx, group, arrayname,
				ndims, "");
	}
	...
	public static double[] get_array_double(H5File h5, int songidx,
		...
		int wantedMember = hdf5_getters
				.find(analysis.getMemberNames(), idxname);
		assert wantedMember >= 0;
		Vector alldata = (Vector) analysis.getData();
		int[] col = (int[]) alldata.get(wantedMember);
	...
	public static int[] get_array_int(H5File h5, int songidx, String group,
		...
		return hdf5_getters.get_array_int(h5, songidx, group, arrayname, "");
	}
	...
	public static String[] get_array_string(H5File h5, int songidx,
		...
		H5CompoundDS analysis = (H5CompoundDS) h5.get(group + "/songs");
		analysis.init();
		int wantedMember = hdf5_getters.find(analysis.getMemberNames(), "idx_"
				+ arrayname);
		assert wantedMember >= 0;
		Vector alldata = (Vector) analysis.getData();
		int[] col = (int[]) alldata.get(wantedMember);
	...
	public static void main(String[] args) {
		...
		H5File h5 = hdf5_getters.hdf5_open_readonly(filename);
		...
		try {
			...
			System.out.println("artist id: " + hdf5_getters.get_artist_id(h5));
			...
			System.out.println("release: " + hdf5_getters.get_release(h5));
			...
			System.out.println("tempo: " + hdf5_getters.get_tempo(h5));
